    ...
    return (
        <div className={cn("fixed top-10 inset-x-0 max-w-2xl mx-auto z-50", className)}>
            <Menu setActive={setActive} >
                <Link href="/"><MenuItem item="Home" setActive={setActive} active={active}></MenuItem></Link>
            ...
            <Link href="/contact"><MenuItem item="Contact Us" setActive={setActive} active={active}></MenuItem></Link> 
            </Menu>
        </div>
    )
}